...
def admin():
    ...
    return render_template("apartmanim/admin.html")
...
def panel():
    ...
    return render_template("apartmanim/panel.html")
...
@app.route("/admin_panel/delete_user/<int:resident_id>", methods=["POST"])
@login_required(role="apartment_admin")
...
@app.route("/admin_panel/resident_page/<int:resident_id>")
@login_required(role="apartment_admin")
...
@app.route("/admin_panel/payment_record", methods=["GET", "POST"])
@login_required(role="apartment_admin")
def payment_record():
    apartment_id = current_user.apartment_id
    residents = Apartment.query.get(apartment_id).residents
...
@app.route("/admin_panel/delete_payment/<int:payment_id>", methods=["POST"])
@login_required(role="apartment_admin")
...
@app.route("/admin_panel/create_receipt/<int:payment_id>", methods=["POST"])
@login_required(role="apartment_admin")
...
@app.route("/admin_panel/financial", methods=["GET", "POST"])
@login_required(role="apartment_admin")
def financial():
...
@app.route("/admin_panel/financial/expenditures", methods=["GET", "POST"])
@login_required(role="apartment_admin")
def expenditures():
    apartment_id = current_user.apartment_id
...
@app.route("/admin_panel/delete_expenditure/<int:expenditure_id>", methods=["POST"])
@login_required(role="apartment_admin")
...
@app.route("/admin_panel/financial/apartment_safe", methods=["GET", "POST"])
@login_required(role="apartment_admin")
def apartment_safe():
